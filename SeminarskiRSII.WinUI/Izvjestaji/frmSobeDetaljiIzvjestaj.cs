...
namespace SeminarskiRSII.WinUI.Izvjestaji
{
    public partial class frmSobeDetaljiIzvjestaj : Form
    {
        ...
        {
            var soba = await _sobaService.getByID<Model.Soba>(id);
            ...
            var listaRezervacija =await _rezervacijeService.get<List<Model.Rezervacija>>(new RezervacijaSearchRequest() { BrojSobe=soba.BrojSobe});
